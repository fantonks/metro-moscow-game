...
- **Изображения:** все картинки станций и поездов хранятся локально в `public/`, только относительные пути, работа в браузере и offline.

---

## Одна команда — запуск с нуля

На другом ПК (после клонирования или распаковки архива):
